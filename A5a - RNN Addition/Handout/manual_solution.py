...
class RNNAdder(object):
    ...
    def __init__(self):
        # SOLUTION HERE
        self.W_ih = np.array([[...]])     # matrix: self.hidden_size x self.input_size
        self.b_ih = np.array([...])       # vector: self.hidden_size x 1
        self.W_hh = np.array([[...]])     # matrix: self.hidden_size x self.hidden_size
        self.b_hh = np.array([...])       # vector: self.hidden_size x 1
