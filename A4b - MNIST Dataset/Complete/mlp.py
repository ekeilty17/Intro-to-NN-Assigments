...
class MLP(nn.Module):
    ...
    def __init__(self, input_size, output_size, num_hidden_layers=2, hidden_size=[500, 500, 100, 10]):
        ...
        self.last = nn.Sequential(
            ...
            #nn.Sigmoid()   # don't need this since we are using nn.CrossEntropyLoss()
        )
